"""
Testing the scraped_to_csv functions, which tbh will likely have the biggest risk factors. especially I live in fear of
the regex for grabbing proper nouns but looks like its passing so... yeah and what.
"""
from pipeline_code.scraped_to_csv import (
    get_proper_nouns,
    split_string_list,
)
